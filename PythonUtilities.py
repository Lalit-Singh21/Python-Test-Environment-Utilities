#####################################################################################################
"""
 Script               : PythonUtilities.py
 Description          : Automation of basic utilities
                        like Archiving, deleting logs restarting machines and clearing temp folders.
 Author               : Lalit Singh
"""
######################################################################################################
...
class PythonUtilities:
    ...
    def SetupLogger(self,logname, id):
        ...
        hdlr = logging.FileHandler(r'W:\NFT\test_results\PyUtilitiesLogs\\%s_%s_%s_%s.log' %(id,logname,self.now,socket.gethostname()))
...
if __name__ == "__main__":
        ...
        parser_CompressLogs.add_argument('-l',dest='LogsPath', default="\\\\filerc-wyn\Robots\Logs", help='Path for Logs, Default is: \\filerc-wyn\Robots\Logs')
        ...
        parser_DeleteLogs.add_argument('-l',dest='LogsPath', default="\\\\filerc-wyn\Robots\Logs", help='Path for Logs, Default is:  \\\\filerc-wyn\Robots\Logs')
        ...
        parser_ClearTemp.add_argument('-t',dest='TempPath', default='C$\Documents and Settings\Robot\Local Settings\Temp', help='enter the Temp path to be cleared, please ensure to change C: as C$. Default Path is: C$\Documents and Settings\Robot\Local Settings\Temp')
        ...
        parser_ClearTemp.add_argument('-c', dest='ConfigPath', default='', help='Add config path, example: \\ukrobot\QTPEnv\MarkitWire_QTP\SupportApps\PythonUtilities\PyUtilities_Configuration.cfg')
        ...
        parser_RestartMachines.add_argument('-c', dest='ConfigPath', default='', help='Add config path, example: \\ukrobot\QTPEnv\MarkitWire_QTP\SupportApps\PythonUtilities\PyUtilities_Configuration.cfg')
        ...
        parser_ClearMWClient.add_argument('-c', dest='ConfigPath', default='', help='Add config path, example: \\ukrobot\QTPEnv\MarkitWire_QTP\SupportApps\PythonUtilities\PyUtilities_Configuration.cfg')
        ...
        parser_LoginMachines.add_argument('-c', dest='ConfigPath', default='', help='Add config path, example: \\ukrobot\QTPEnv\MarkitWire_QTP\SupportApps\PythonUtilities\PyUtilities_Configuration.cfg')
